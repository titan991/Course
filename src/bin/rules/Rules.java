...
public class Rules {
    ...
    private boolean isProgram() throws Exception {
        ...
        if(!listIteratorsTokens.next().getItem().equals("begin")){
    ...
    private boolean isDescription() throws Exception {
        ...
        boolean varStart = listIteratorsTokens.next().getItem().equals("var");
        ...
        if(!varStart)
            throw new Exception("Описание должно начинаться с var!");
