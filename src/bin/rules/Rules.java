...
public class Rules {
    ...
    private boolean isProgram() throws Exception {
        ...
        if (!listIteratorsTokens.next().getItem().equals("{")) {
            throw new Exception("Программа должна начинаться с {!");
        }
        while (listIteratorsTokens.hasNext()) {
            ...
            if (listIteratorsTokens.next().getItem().equals("}") & isProgram) {
                ...
                throw new Exception("Программа должна заканчиваться на }!");
    ...
    private boolean isDescription() throws Exception {
        ...
        boolean varStart = listIteratorsTokens.next().getItem().equals("dim");
        if (!varStart) listIteratorsTokens.previous();
        skipLineTranslation();
        ...
        if (!varStart)
            throw new Exception("Описание должно начинаться с dim!");
    ...
    private TypesData isOperatorAssignment() throws Exception {
        ...
        if (next.getTypeData().equals(TypesData.FLOAT)) {
            if (bufTypesData.equals(TypesData.FLOAT) | bufTypesData.equals(TypesData.INT)) {
    ...
    private TypesData isExpression() throws Exception {
        ...
        while (listIteratorsTokens.hasNext()) {
            ...
            if (bufType.equals(TypesData.INT) | bufType.equals(TypesData.FLOAT)) {
                bufType = isOperand();
                if (bufType.equals(TypesData.FLOAT) | bufType.equals(TypesData.INT)) {
    ...
    private TypesData isOperand() throws Exception {
        ...
        while (listIteratorsTokens.hasNext()) {
            ...
            if (bufType.equals(TypesData.BOOL)) {
            ...
            } else if (bufType.equals(TypesData.INT) | bufType.equals(TypesData.FLOAT)) {
                if (next.getItem().equals("plus") | next.getItem().equals("min")) {
                    ...
                    } else if (bufType.equals(TypesData.FLOAT)) {
                        bufType = isTerm();
                        if (bufType.equals(TypesData.INT) | bufType.equals(TypesData.FLOAT)) {
                            return TypesData.INT;
                        }
